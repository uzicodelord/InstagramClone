        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card justify-content-center align-items-center" style="margin-left: 40%;height: auto;width: 40%;background-color: #fff;">
                    <img src="{{ asset('images/instagram-logo.png') }}" alt="" style="height: 60px;margin-top: 40px;margin-bottom: 40px;">
                    ...
                    <div class="card-footer text-center">
                        Don't have an account?<span> <a href="{{ route('register') }}" style="text-decoration: none">Sign up</a></span>
                    </div>
                </div>
            </div>
        </div>
